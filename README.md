...
- backend: Go HTTP server API for health + score leaderboard
...
- https://pacman-go-backend.fly.dev
...
- App name in fly.toml is pacman-go-backend; change it if already taken.
...
Node, npm, Go, fly CLI, and Vercel CLI are installed.
